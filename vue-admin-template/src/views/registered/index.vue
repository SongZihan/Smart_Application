<template>
  <div class="registered-container">
    <el-form ref="registeredForm" :model="registeredForm" :rules="registeredRules" class="registered-form" auto-complete="on" label-position="left">

      <div class="title-container">
        <h3 class="title">registered Form</h3>
      </div>
      ...
      <el-form-item prop="invite_code">
        <span class="svg-container">
          <svg-icon icon-class="invite_code" />
        </span>
        <el-input
          :key="passwordType"
          ref="invite_code"
